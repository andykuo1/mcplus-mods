...
public abstract class RecipesDyeable implements IRecipe
{
	public final Item recipeItem;

	public RecipesDyeable(Item input)
	{
	...
	public ItemStack getCraftingResult(InventoryCrafting p_77572_1_)
	{
		...
		for (k = 0; k < p_77572_1_.getSizeInventory(); ++k)
		{
			...
			if (itemstack1 != null)
			{
				if (itemstack1.getItem() == this.recipeItem)
				{
					...
					if (this.hasColor(itemstack1))
					{
						l = this.getColor(itemstack);
		...
		else
		{
			...
			l1 = (k << 8) + i1;
			l1 = (l1 << 8) + l;
			this.setColor(itemstack, l1);
			return itemstack;
		}
	}

	protected abstract void setColor(ItemStack itemstack, int color);
