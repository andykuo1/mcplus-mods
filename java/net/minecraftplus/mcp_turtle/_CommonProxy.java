...
public class _CommonProxy extends Proxy
{
	...
	public void Initialize()
	{
		...
		MCS.entity(EntityTurtle.class, "Turtle", eggColor_main, eggColor_ext);
		EntityRegistry.addSpawn(EntityTurtle.class, 4, 0, 3, EnumCreatureType.CREATURE, BiomeGenBase.swampland);
