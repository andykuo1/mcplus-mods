...
public class SlotLoom extends Slot
{
    ...
    public SlotLoom(EntityPlayer player, IInventory p_i45793_2_, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = LoomRecipes.instance().getSmeltingExperience(stack);
            int j;
        ...
        //TODO: Add Achievement : SILK MASTER
    }
}