...
public class RecipesDyeable implements IRecipe
{
	...
	public RecipesDyeable(Item parItem)
	{
		this.input = parItem;
	}
	...
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (int i = 0; i < par1InventoryCrafting.getSizeInventory(); ++i)
		{
			...
			if (itemstack1 != null)
			{
				if (itemstack1.getItem() == this.getInput())
				{
					if (itemstack != null)
					{
						return false;
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
	{
		...
		for (k = 0; k < par1InventoryCrafting.getSizeInventory(); ++k)
		{
			...
			if (itemstack1 != null)
			{
				if (itemstack1.getItem() == this.getInput())
				{
					item = (IItemDyeable) itemstack1.getItem();
	...
	{
		return new ItemStack(this.getInput());
	}
}