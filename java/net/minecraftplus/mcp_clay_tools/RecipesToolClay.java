...
public class RecipesToolClay extends RecipesShaped
{
	public RecipesToolClay(int width, int height, Item output, char... inputs)
	{
		super(width, height, true, new ItemStack((ItemToolClay) output), inputs);
	}
	...
	public ItemStack getCraftingResult(InventoryCrafting inventorycrafting)
	{
		...
		ItemToolClay item = (ItemToolClay) itemstack.getItem();
		int[] rgb = new int[3];
		int i = 0;
		int j = 0;
