...
public class RecipesHoeClay extends RecipesShaped
{
	public RecipesHoeClay(int width, int height, Item output, char... inputs)
	{
		super(width, height, true, new ItemStack((ItemHoeClay) output), inputs);
	}
	...
	public ItemStack getCraftingResult(InventoryCrafting par1InventoryCrafting)
	{
		...
		ItemHoeClay item = (ItemHoeClay) itemstack.getItem();
		int[] rgb = new int[3];
		int i = 0;
		int j = 0;
