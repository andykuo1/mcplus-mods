...
public class ContainerPigeon extends Container
{
	...
	public ContainerPigeon(EntityPlayer parEntityPlayer, EntityPigeon parEntityPigeon)
	{
		...
		if (this.pigeon.isChested())
		{
			...
			this.columns = 5;
			this.addChestSlotsToContainer(this.invUp, 80, 18, 1, this.rows, this.columns);
		}
		else
		{
			this.rows = 0;
		...
		this.addPlayerSlotsToContainer(this.invDown, 7, 102 + i);
	}
	...
	{
		return this.invUp.isUseableByPlayer(parEntityPlayer) && this.pigeon.isEntityAlive() && this.pigeon.isTamed();
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer parEntityPlayer, int parSlot)
	{
		...
		if (slot != null && slot.getHasStack())
		{
			...
			else if (!this.mergeItemStack(itemstack1, 1, this.invUp.getSizeInventory(), false))
			{
				return null;
			}
	...
	public void onContainerClosed(EntityPlayer p_75134_1_)
	{
		...
		this.invUp.closeInventory(p_75134_1_);
	}
}
