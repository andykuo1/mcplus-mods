...
public class RecipesPickaxeClay implements IRecipe
{
	@Override
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (i = 0; i < 1; i++)
		{
			...
			{
				slots = new int[] {i, i + 1, i + 2, i + 4, i + 7};
				break;
			}
		}
	...
	{
		ItemStack itemstack = new ItemStack(ModClayTools.pickaxeClay);
	...
	{
		return new ItemStack(ModClayTools.pickaxeClay);
	}
}
