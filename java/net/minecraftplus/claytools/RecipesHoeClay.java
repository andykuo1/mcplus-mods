...
public class RecipesHoeClay implements IRecipe
{
	@Override
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (i = 0; i < 2; i++)
		{
			...
			if (itemstack != null && Block.getBlockFromItem(itemstack.getItem()) == Blocks.stained_hardened_clay)
			{
				...
				if (itemstack1 != null)
				{
					slots = new int[] {i, i + 1, i + 3, i + 6};
				}
				else
				{
					slots = new int[] {i, i + 1, i + 4, i + 7};
				}
				break;
			}
		}
	...
	{
		ItemStack itemstack = new ItemStack(ModClayTools.hoeClay);
	...
	{
		return new ItemStack(ModClayTools.hoeClay);
	}
}
