...
public class RecipesAxeClay implements IRecipe
{
	@Override
	public boolean matches(InventoryCrafting par1InventoryCrafting, World par2World)
	{
		...
		for (i = 0; i < 2; i++)
		{
			...
			{
				ItemStack itemstack1 = par1InventoryCrafting.getStackInSlot(i + 3);
				if (itemstack1 == null) return false;

				if (Block.getBlockFromItem(itemstack.getItem()) == Blocks.stained_hardened_clay)
				{
					slots = new int[] {i, i + 1, i + 3, i + 4, i + 7};
				}
				else
				{
					slots = new int[] {i, i + 1, i + 4, i + 3, i + 6};
				}
				break;
			}
		}
	...
	{
		ItemStack itemstack = new ItemStack(ModClayTools.axeClay);
	...
	{
		return new ItemStack(ModClayTools.axeClay);
	}
}
