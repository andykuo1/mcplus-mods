...
public class EventSweetPotatoDropHandler
{
	...
	public void onBlockBreak(BreakEvent par1Event)
	{
		if (!par1Event.world.isRemote && par1Event.block == Blocks.grass)
		{
			...
			{
				par1Event.world.spawnEntityInWorld(new EntityItem(par1Event.world, par1Event.x + 0.5F, par1Event.y + 0.5F, par1Event.z + 0.5F, new ItemStack(MCP_SweetPotato.sweetPotato)));
			}
		}
	}
}
