...
public class RenderLoom extends TileEntitySpecialRenderer implements IItemRenderer
{
	...
	private static final ResourceLocation res_Loom = new ResourceLocation("minecraftplus:textures/blocks/" + MCP_Loom.loom.getUnlocalizedName() + ".png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double par2, double par4, double par6, float par8)
	{
		...
		if(tileentity instanceof TileEntityLoom)
		{
			...
			f5 = tileentityloom.getWheelAngle();
		}
	...
	{
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityLoom(), 0D, 0D, 0D, 0F);
	}
}
