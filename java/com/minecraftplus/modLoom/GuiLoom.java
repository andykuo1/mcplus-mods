...
{
	private static final ResourceLocation res_Loom = new ResourceLocation("minecraftplus:textures/gui/container_loom.png");
	private TileEntityLoom loomInventory;

	public GuiLoom(EntityPlayer par1EntityPlayer, TileEntityLoom par2TileEntityLoom)
	{
		super(new ContainerLoom(par1EntityPlayer, par2TileEntityLoom));
		this.loomInventory = par2TileEntityLoom;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		this.mc.renderEngine.bindTexture(res_Loom);
