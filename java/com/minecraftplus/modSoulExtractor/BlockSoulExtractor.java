...
public class BlockSoulExtractor extends BlockContainer
{
	...
	{
		this.blockIcon = parIIconRegister.registerIcon("minecraftplus:" + this.getUnlocalizedName() + ".side");
		this.blockIcon1 = parIIconRegister.registerIcon("minecraftplus:" + this.getUnlocalizedName() + ".top");
		this.blockIcon2 = parIIconRegister.registerIcon("minecraftplus:" + this.getUnlocalizedName() + ".bottom");
	}
