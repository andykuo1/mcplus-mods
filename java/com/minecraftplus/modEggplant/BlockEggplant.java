...
public class BlockEggplant extends BlockCrops
{
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, Block par5Block, int par6)
	{
		...
		if (par1World.getBlock(par2, par3 - 1, par4) == MCP_Eggplant.eggplantsBase)
		{
	...
	{
		return par1World.getBlock(par2, par3 - 1, par4) == MCP_Eggplant.eggplantsBase;
	}
}