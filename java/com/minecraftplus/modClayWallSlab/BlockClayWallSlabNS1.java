...
public class BlockClayWallSlabNS1 extends BlockClayWallSlab1
{
	public BlockClayWallSlabNS1(boolean par1, Material par2Material)
	{
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase parEntityLivingBase, ItemStack parItemStack)
	{
		...
		if (l == 1)
		{
			par1World.setBlock(par2, par3, par4, MCP_ClayWallSlab.clayWallHalfSlabWE1);
			MCP_ClayWallSlab.clayWallHalfSlabWE1.onBlockPlacedBy(par1World, par2, par3, par4, parEntityLivingBase, parItemStack);
		}
	...
	{
		return block == MCP_ClayWallSlab.clayWallHalfSlabNS1;
	}
	...
	{
		return Item.getItemFromBlock(MCP_ClayWallSlab.clayWallHalfSlabNS1); 
	}
}