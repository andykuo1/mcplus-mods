...
{
	public BlockClayWallSlab2(boolean par1, Material par2Material, boolean par3)
	{
	...
	{
		return new ItemStack(MCP_ClayWallSlab.clayWallHalfSlabNS2, 1, (par2World.getBlockMetadata(par3, par4, par5) & 7) + this.getColorRange());
	}
}
