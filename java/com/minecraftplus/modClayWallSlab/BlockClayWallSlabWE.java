...
public class BlockClayWallSlabWE extends BlockClayWallSlab
{
	public BlockClayWallSlabWE(boolean par1, Material par2Material)
	{
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase parEntityLivingBase, ItemStack parItemStack)
	{
		...
		if (l == 0)
		{
			par1World.setBlock(par2, par3, par4, MCP_ClayWallSlab.clayWallHalfSlabNS);
			MCP_ClayWallSlab.clayWallHalfSlabNS.onBlockPlacedBy(par1World, par2, par3, par4, parEntityLivingBase, parItemStack);
		}
	...
	{
		return block == MCP_ClayWallSlab.clayWallHalfSlabWE;
	}
	...
	{
		return Item.getItemFromBlock(MCP_ClayWallSlab.clayWallHalfSlabWE); 
	}

	@SideOnly(Side.CLIENT)
	public void getSubBlocks(Item par1Item, CreativeTabs par2CreativeTabs, List par3List)
	{
		if (par1Item != Item.getItemFromBlock(MCP_ClayWallSlab.clayWallDoubleSlabWE))
		{
