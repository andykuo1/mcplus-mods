...
public class BlockClayWallSlabWE1 extends BlockClayWallSlab1
{
	public BlockClayWallSlabWE1(boolean par1, Material par2Material)
	{
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase parEntityLivingBase, ItemStack parItemStack)
	{
		...
		if (l == 0)
		{
			par1World.setBlock(par2, par3, par4, MCP_ClayWallSlab.clayWallHalfSlabNS1);
			MCP_ClayWallSlab.clayWallHalfSlabNS1.onBlockPlacedBy(par1World, par2, par3, par4, parEntityLivingBase, parItemStack);
		}
	...
	{
		return block == MCP_ClayWallSlab.clayWallHalfSlabWE1;
	}
	...
	{
		return Item.getItemFromBlock(MCP_ClayWallSlab.clayWallHalfSlabWE1); 
	}
}