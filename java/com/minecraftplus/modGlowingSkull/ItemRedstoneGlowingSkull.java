...
public class ItemRedstoneGlowingSkull extends ItemSkull
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			else if (!MCP_GlowingSkull.redstoneGlowingSkulls.canPlaceBlockAt(par3World, par4, par5, par6))
			{
				return false;
			}
			else
			{
				par3World.setBlock(par4, par5, par6, MCP_GlowingSkull.redstoneGlowingSkulls, par7, 2);
				int i1 = 0;
				...
				if (tileentity != null && tileentity instanceof TileEntityRedstoneGlowingSkull)
				{
					String s = "";
					...
					((TileEntityRedstoneGlowingSkull)tileentity).func_145905_a(par1ItemStack.getItemDamage(), s);
					((TileEntityRedstoneGlowingSkull)tileentity).func_145903_a(i1);
					((BlockRedstoneGlowingSkull)MCP_GlowingSkull.redstoneGlowingSkulls).func_149965_a(par3World, par4, par5, par6, (TileEntityRedstoneGlowingSkull)tileentity);
				}
