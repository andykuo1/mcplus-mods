...
public class RenderRedstoneGlowingSkull extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntityAt(TileEntityRedstoneGlowingSkull par1TileEntity, double par2, double par3, double par4, float par5)
	{
	...
	{
		this.renderTileEntityAt((TileEntityRedstoneGlowingSkull)par1TileEntity, par2, par3, par4, par5);
	}
}