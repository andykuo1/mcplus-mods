...
public class ItemSkullCandle extends ItemSkull
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			else if (!MCP_SkullCandle.skullCandles.canPlaceBlockAt(par3World, par4, par5, par6))
			{
				return false;
			}
			else
			{
				par3World.setBlock(par4, par5, par6, MCP_SkullCandle.skullCandles, par7, 2);
				int i1 = 0;
				...
				if (tileentity != null && tileentity instanceof TileEntitySkullCandle)
				{
					...
					((TileEntitySkullCandle)tileentity).func_145905_a(par1ItemStack.getItemDamage(), s);
					((TileEntitySkullCandle)tileentity).func_145903_a(i1);
					((BlockSkullCandle)MCP_SkullCandle.skullCandles).func_149965_a(par3World, par4, par5, par6, (TileEntitySkullCandle)tileentity);
				}
