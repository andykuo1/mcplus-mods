...
public class RenderRedstoneSkullCandle extends TileEntitySpecialRenderer
{
	...
	public static RenderRedstoneSkullCandle field_147536_b;
	...
	public void renderTileEntityAt(TileEntityRedstoneSkullCandle par1TileEntity, double par2, double par3, double par4, float par5)
	{
		...
		Blocks.redstone_torch.setBlockBoundsBasedOnState(renderBlocks.blockAccess, par1TileEntity.xCoord, par1TileEntity.yCoord, par1TileEntity.zCoord);
		renderBlocks.setRenderBoundsFromBlock(Blocks.redstone_torch);
		this.renderBlockTorch(renderBlocks, Blocks.redstone_torch, par1TileEntity.xCoord, par1TileEntity.yCoord, par1TileEntity.zCoord);
