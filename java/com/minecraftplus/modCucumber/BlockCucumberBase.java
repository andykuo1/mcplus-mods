...
public class BlockCucumberBase extends BlockCrops
{
	@SideOnly(Side.CLIENT)
	private IIcon[] itemIcons;

	public BlockCucumberBase()
	{
		super();
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		{
			par1World.setBlock(par2, par3 + 1, par4, MCP_Cucumber.cucumbers, 0, 2);
		}
	}
	...
	public void func_149863_m(World par1World, int par2, int par3, int par4)
	{
		...
		if (l >= 7)
		{
			...
			else if (par1World.getBlock(par2, par3 + 1, par4) == MCP_Cucumber.cucumbers)
			{
	...
	{
		return par1World.getBlockMetadata(par2, par3, par4) != 7 || (par1World.isAirBlock(par2, par3 + 1, par4) ? true : (par1World.getBlock(par2, par3 + 1, par4) == MCP_Cucumber.cucumbers ? par1World.getBlockMetadata(par2, par3 + 1, par4) != 7 : false));
	}

	@Override
	protected Item func_149866_i()
	{
		return MCP_Cucumber.cucumberSeeds;
	}
