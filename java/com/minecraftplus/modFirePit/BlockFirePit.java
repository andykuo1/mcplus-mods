...
public class BlockFirePit extends BlockContainer
{
	...
	{
		return Item.getItemFromBlock(MCP_FirePit.firePit);
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					par5EntityPlayer.openGui(MCP_FirePit.INSTANCE, 0, par1World, par2, par3, par4);
				}
			}
	...
	public static void updateFirePitBlockState(boolean par1, World par2World, int par3, int par4, int par5)
	{
		...
		if (par1)
		{
			par2World.setBlock(par3, par4, par5, MCP_FirePit.firePitLit);
		...
		{
			par2World.setBlock(par3, par4, par5, MCP_FirePit.firePit);
		}
