...
public class RenderFirePit extends TileEntitySpecialRenderer implements IItemRenderer
{
	...
	private static final ResourceLocation firePitTexture = new ResourceLocation("minecraftplus:textures/blocks/" + MCP_FirePit.firePit.getUnlocalizedName() + ".png");
	private static final ResourceLocation firePitLitTexture = new ResourceLocation("minecraftplus:textures/blocks/" + MCP_FirePit.firePit.getUnlocalizedName() + "_lit" + ".png");
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8)
	{
		...
		if(par1TileEntity instanceof TileEntityFirePit)
		{
			...
			if (!tileentityfirepit.isItem())
			{
				...
				if (blockfirepit == MCP_FirePit.firePitLit)
				{
